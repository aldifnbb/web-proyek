...
const Bab1 = () => {
    ...
    const [open, setOpen] = useState(""); // Menyimpan ID Accordion yang terbuka

    // State untuk Tooltip
    const [tooltipOpen1, setTooltipOpen1] = useState(false); // Tooltip untuk opsi 1
    const [tooltipOpen2, setTooltipOpen2] = useState(false); // Tooltip untuk opsi 2

    // Fungsi toggle Accordion
    const toggle = (id) => {
        setOpen(open === id ? "" : id); // Jika Accordion sudah terbuka, tutup; jika tidak, buka
    };
